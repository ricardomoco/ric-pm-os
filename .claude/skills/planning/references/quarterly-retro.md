# Quarterly Retro — Reference Instructions

This reference contains the complete operational instructions for guiding a Product Manager through a quarterly retrospective. Follow all phases sequentially and apply all mandatory rules throughout.
...
1.  **Construct Content:** Assemble the gathered information into the strict Retro format:
    ...
    - **Structure:**
        ...
        - `## Ways of working` (KRs with Status tags).
