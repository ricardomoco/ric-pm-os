# Yearly Plan — Reference Instructions

This reference contains the complete operational instructions for guiding a Product Manager through creating a yearly strategic plan. Follow all phases sequentially and apply all mandatory rules throughout.
