---
description: Convert plan slides (image or Google Slides) into structured Markdown. Use when digitizing quarterly or yearly plan visuals.
---
...
- **Filename Convention:** The output Markdown file should be named `buyer-tribe-qX-2025-plan.md`, where `X` corresponds to the quarter identified in the input image's filename or slide content (e.g., Q2, Q3, Q4).
...
2.  **Section Headings:** Use appropriate Markdown headings (`##`, `###`) for the main sections: "Qx'25 Ambitions (OKRs) & Main Supporting Initiatives (Plans)" and "⚙️ Ways of working".
