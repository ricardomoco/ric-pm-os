---
description: Convert retro slides (image or Google Slides) into structured Markdown. Use when digitizing quarterly or yearly retrospective visuals.
---
...
- **Filename Convention:** The output Markdown file should be named `buyer-tribe-qX-2025-retro.md`, where `X` corresponds to the quarter identified in the input image's filename or slide content (e.g., Q2, Q3, Q4).
...
3.  **Section Headings:** Use appropriate Markdown headings (`##`, `###`) for the main sections: "Qx'25 Actuals (OKRs) & Key Learnings" and "⚙️ Ways of working".
