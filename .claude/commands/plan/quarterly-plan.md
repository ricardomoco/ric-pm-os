---
description: Guides the user through a methodical quarterly tactical planning process.
---
...
2.  **Update the Google Sheet:**
    *   Announce your intention to update the sheet.
    *   Use `modify_sheet_values` to perform a **single, comprehensive update** to the planning sheet (e.g., `2026 Q1 Plan - Backup`), clearing old data (except headers) and writing the new plan.
3.  **Final Allocation Analysis:**
    *   Re-read the "Team resources" and the updated planning sheet.
